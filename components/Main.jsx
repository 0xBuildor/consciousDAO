    ...
    return (
        <>
            <div className="h-screen overflow-hidden">
               ...
               <div
                className="relative z-30 p-8 max-w-xs md:max-w-md mx-auto my-20 bg-contain bg-white  rounded-xl shadow-lg flex flex-col items-center justify-center space-x-4 ring-offset-2 ring-4">
                    <div>
