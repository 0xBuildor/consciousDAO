        ...
        <>
            <div className="h-screen overflow-hidden">
                ...
                className="relative z-30 flex flex-row items-center justify-center mt-24  ">
                    <a href="#" >
                        <img
                            className=" z-10 bg-transparent w-60 md:w-80 h-auto"
                            src="Assets/Logo.svg"
                            alt=""
                        />
                    </a>
               ...
               <div
                className="relative z-30 p-8 max-w-xs md:max-w-md m-10 mx-auto my-20 bg-contain bg-white  rounded-xl shadow-lg flex flex-col items-center justify-center space-x-4 ring-offset-2 ring-4 opacity-96">
                    <div>
